...
FOX=/usr/local/lecode/gnu/FoX/bin

# Linked libraries

TRIANGLELIB=/usr/local/lecode/gnu/triangle

HDF5=/usr/local/lecode/gnu/hdf5
H5LDFLAGS = -L${HDF5}/lib 
H5FLAGS = -I${HDF5}/include
H5LIBS =  -lhdf5_fortran -lhdf5  -lhdf5hl_fortran -lhdf5_hl -L/usr/local/lecode/gnu/zlib/lib -lz -ldl -lstdc++


KDTREE=/usr/local/lecode/gnu/kdtree2 
