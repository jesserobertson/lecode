...
contains
    ...
    subroutine create_vtk_topsurface( uorl )
        ...
        write( iunit,'(a10,1x,i10,1x,i10,1x,i2)')'DIMENSIONS',strat_X,strat_Y,1
        write(iunit,'(a6,1x,f12.3,1x,f12.3,1x,f12.3)')'ORIGIN',strat_xo,strat_yo,0.0
        write(iunit,'(a7,1x,f12.3,1x,f12.3,1x,f12.3)')'SPACING',strat_dx,strat_dx,1.0
        write(iunit,'(a10,1x,i10)')'POINT_DATA',strat_X*strat_Y
        ...
        do k = 1, strat_Y
            do n = 1, strat_X - 1
                p = p + 1
                write(iunit,'(f12.3,1x)',advance='no') elev_record( p )
            enddo
            p = p + 1
            write(iunit,'(f12.3)') elev_record( p )
        enddo
